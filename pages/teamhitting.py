...
last_row_index2 = len(team_hitting_stats) - 1
team_hitting_stats.drop(last_row_index2, inplace=True)
...
teamhitting_columns_to_convert = ['PA','AB','R','H','1B','2B','RBI','BB','K','TTO','SB','HBP','TB','XBH','GO','FO','RC']
for column in teamhitting_columns_to_convert:
...
layout=dbc.Container(
    ...
    html.H1('2024 Prospect League Team Hitting Overview',className='text-center text-dark mt-3 mb-2 fs-1'),
